...
* Ported underlying SAT engine from `PicoSAT`_ to `z3`_ to avoid in-project C compilation dependency
...
`````
    ...
    * Add initial wrapper around `PicoSAT`_ library for future satisfiability interface; namely, the ``sat_one`` method
...
.. _Napoleon: https://www.sphinx-doc.org/en/stable/ext/napoleon.html
.. _PicoSAT: https://fmv.jku.at/picosat/
.. _z3: https://github.com/Z3Prover/z3
.. _Sphinx: https://www.sphinx-doc.org/en/stable/index.html
