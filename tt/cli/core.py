...
from tt.errors import EmptyExpressionError, GrammarError
...
def get_parsed_args(args=None):
    ...
    parser_tokens = sub_parsers.add_parser(
        "tokens", help="print the expression's tokens in order of appearance"
    )
    ...
    parser_postfix_tokens = sub_parsers.add_parser(
        "postfix-tokens", help="print the expression's tokens in postfix order"
    )
    ...
    parser_tree = sub_parsers.add_parser(
        "tree", help="print the expression's tree representation"
    )
    ...
    parser_table = sub_parsers.add_parser(
        "table", help="print the expression's truth table"
    )
