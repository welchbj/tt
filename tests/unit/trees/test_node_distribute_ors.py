...
from tt.definitions import BINARY_OPERATORS, TT_AND_OP, TT_OR_OP
...
class TestNodeDistributeOrs(ExpressionTreeAndNodeTestCase):
    ...
    def test_binary_op_no_change_expected(self):
        ...
        self.assertTrue(dor.r_child.r_child.l_child is not root.r_child.r_child.l_child)
        self.assertTrue(dor.r_child.r_child.r_child is not root.r_child.r_child.r_child)
        self.assertEqual(
            str(dor),
            "\n".join(
                (
    ...
    def test_applicable_or_distribute_from_right(self):
        ...
        self.assertTrue(dor.r_child.l_child.l_child is not root.l_child.r_child)
        self.assertTrue(dor.r_child.r_child.l_child is not root.l_child.r_child.r_child)
