...
class TestNodeIterClauses(ExpressionTreeAndNodeTestCase):
    ...
    def test_iter_cnf_multi_clauses(self):
        ...
        root = self.get_tree_root_from_expr_str("(A or B or C) and (D or E or F)")
    ...
    def test_dnf_when_not_dnf(self):
        ...
        root = self.get_tree_root_from_expr_str("(A or B) and (C or D) and (E or F)")
    ...
    def test_iter_dnf_multi_clauses(self):
        ...
        root = self.get_tree_root_from_expr_str("(A and B and C) or (D and E and F)")
