...
class TestTreeNodeIsCnf(unittest.TestCase):
    ...
    def test_is_cnf_contains_non_primitive_operator_in_clause(self):
        ...
        self.assert_not_cnf(
            ["A", "B", "or", "C", "D", "or", "D", "E", "nand", "and", "and"]
        )
        self.assert_not_cnf(["A", "B", "C", "xor", "or", "A", "B", "or", "and"])
