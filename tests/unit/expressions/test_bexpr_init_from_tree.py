...
class TestBooleanExpressionInitFromTrees(unittest.TestCase):
    ...
    def test_negated_single_operand_clauses(self):
        ...
        self.assertEqual(b.symbols, ["A", "B", "C", "D"])
        self.assertEqual(
            b.tokens,
            [
                "not",
    ...
    def test_parens_for_leading_chained_operator_clause(self):
        ...
        b = self._bexpr_from_postfix_tokens(
            ["A", "B", "C", "D", "and", "and", "and", "E", "or"]
        )
        self.assertEqual(b.symbols, ["A", "B", "C", "D", "E"])
        self.assertEqual(
            b.tokens, ["(", "A", "and", "B", "and", "C", "and", "D", ")", "or", "E"]
        )
        self.assertEqual(
            b.postfix_tokens, ["A", "B", "C", "D", "and", "and", "and", "E", "or"]
        )
        self.assertEqual(b.raw_expr, "(A and B and C and D) or E")
        self.assertTrue(b.tree is not None)

    def test_parens_for_trailing_chained_operator_clause(self):
        """Test paren insertion for a trailing clause of chained operators."""
        b = self._bexpr_from_postfix_tokens(
            ["A", "B", "C", "or", "D", "E", "F", "or", "or", "and", "and"]
        )
        self.assertEqual(b.symbols, ["A", "B", "C", "D", "E", "F"])
        self.assertEqual(
            b.tokens,
            [
                "A",
    ...
    def test_parens_for_negated_leading_chained_operator_clause(self):
        ...
        self.assertEqual(b.symbols, ["A", "B"])
        self.assertEqual(
            b.tokens, ["!", "(", "A", "iff", "B", ")", "and", "0", "and", "1"]
        )
        self.assertEqual(
            b.postfix_tokens, ["A", "B", "iff", "!", "0", "1", "and", "and"]
        )
    ...
    def test_parens_for_sandwiched_negated_chained_operator_clause(self):
        ...
        self.assertEqual(b.symbols, ["A", "B", "C", "D", "E"])
        self.assertEqual(
            b.tokens, ["A", "->", "~", "(", "B", "xor", "C", "xor", "D", ")", "->", "E"]
        )
        self.assertEqual(
            b.postfix_tokens, ["A", "B", "C", "D", "xor", "xor", "~", "E", "->", "->"]
        )
    ...
    def test_parens_for_trailing_negated_chained_operator_clause(self):
        ...
        b = self._bexpr_from_postfix_tokens(
            ["A", "B", "C", "D", "E", "and", "and", "not", "xnor", "xnor"]
        )
        self.assertEqual(b.symbols, ["A", "B", "C", "D", "E"])
        self.assertEqual(
            b.tokens,
            ["A", "xnor", "B", "xnor", "not", "(", "C", "and", "D", "and", "E", ")"],
        )
        self.assertEqual(
            b.postfix_tokens,
            ["A", "B", "C", "D", "E", "and", "and", "not", "xnor", "xnor"],
    ...
    def test_parens_for_nested_chained_clause(self):
        ...
        self.assertEqual(
            b.raw_expr,
            "~(A xor ((B -> C -> D) nand E)) iff (~(A xor B) nand (!(A xnor B) or C))",
        )
        self.assertTrue(b.tree is not None)
    ...
    def test_parens_for_leading_single_operand_same_op_as_next(self):
        ...
        b = self._bexpr_from_postfix_tokens(["A", "B", "C", "and", "and"])
        self.assertEqual(b.symbols, ["A", "B", "C"])
        self.assertEqual(b.tokens, ["A", "and", "B", "and", "C"])
        self.assertEqual(b.postfix_tokens, ["A", "B", "C", "and", "and"])
        self.assertEqual(b.raw_expr, "A and B and C")
        self.assertTrue(b.tree is not None)
    ...
    def test_parens_for_trailing_single_operand_same_op_as_prev(self):
        ...
        b = self._bexpr_from_postfix_tokens(["A", "B", "and", "C", "and"])
        self.assertEqual(b.symbols, ["A", "B", "C"])
        self.assertEqual(b.tokens, ["A", "and", "B", "and", "C"])
        self.assertEqual(b.postfix_tokens, ["A", "B", "and", "C", "and"])
        self.assertEqual(b.raw_expr, "A and B and C")
        self.assertTrue(b.tree is not None)
    ...
    def test_parens_for_sandwiched_single_operand_same_op_as_neighbors(self):
        ...
        b = self._bexpr_from_postfix_tokens(
            ["A", "B", "and", "C", "D", "E", "and", "and", "and"]
        )
        self.assertEqual(b.symbols, ["A", "B", "C", "D", "E"])
        self.assertEqual(
            b.tokens, ["A", "and", "B", "and", "C", "and", "D", "and", "E"]
        )
        self.assertEqual(
            b.postfix_tokens, ["A", "B", "and", "C", "D", "E", "and", "and", "and"]
        )
        self.assertEqual(b.raw_expr, "A and B and C and D and E")
        self.assertTrue(b.tree is not None)
