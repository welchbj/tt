...
class TestBooleanExpressionParsingExceptions(ExpressionTestCase):
    def test_empty(self):
        ...
        self.helper_test_tokenization_raises("", expected_exc_type=EmptyExpressionError)
    ...
    def test_leading_symbolic_operators(self):
        ...
        self.helper_test_tokenization_raises(
            "&&A && B", expected_exc_type=ExpressionOrderError, expected_error_pos=0
        )

    def test_consecutive_middle_symbolic_operators(self):
        """Test two consecutive binary operators within an expression."""
        self.helper_test_tokenization_raises(
            "A & (| B)", expected_exc_type=ExpressionOrderError, expected_error_pos=5
        )
    ...
    def test_leading_plain_english_operators(self):
        ...
        self.helper_test_tokenization_raises(
            "and and B", expected_exc_type=ExpressionOrderError, expected_error_pos=0
        )

    def test_consecutive_middle_plain_english_operators(self):
        """Test two consecutive binary operators within an expression."""
        self.helper_test_tokenization_raises(
            "(A or or B)", expected_exc_type=ExpressionOrderError, expected_error_pos=6
        )
    ...
    def test_trailing_unary_symbolic_operator(self):
        ...
        self.helper_test_tokenization_raises(
            "A NAND B !", expected_exc_type=ExpressionOrderError, expected_error_pos=9
        )

    def test_single_plain_english_operator(self):
        """Test a single plain English operator."""
        self.helper_test_tokenization_raises(
            "NOT", expected_exc_type=ExpressionOrderError, expected_error_pos=0
        )

    def test_single_symbolic_operator(self):
        """Test a single symbolic operator."""
        self.helper_test_tokenization_raises(
            "&", expected_exc_type=ExpressionOrderError, expected_error_pos=0
        )
    ...
    def test_single_unbalanced_right_paren(self):
        ...
        self.helper_test_tokenization_raises(
            "(A or B))", expected_exc_type=UnbalancedParenError, expected_error_pos=8
        )
    ...
    def test_empty_paren_scope(self):
        ...
        self.helper_test_tokenization_raises(
            "()", expected_exc_type=BadParenPositionError, expected_error_pos=1
        )
    ...
    def test_invalid_symbol_names(self):
        ...
        self.helper_test_tokenization_raises(
            "for or i", expected_exc_type=InvalidIdentifierError, expected_error_pos=0
        )
