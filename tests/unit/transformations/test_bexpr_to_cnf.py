...
class TestExpressionToCnf(unittest.TestCase):
    ...
    def test_from_boolean_expression_object(self):
        ...
        self.assert_to_cnf_transformation(BooleanExpression("A or B"), "A or B")
    ...
    def test_simple_xor(self):
        ...
        self.assert_to_cnf_transformation("A xor B", "(not B or not A) and (A or B)")
    ...
    def test_simple_xnor(self):
        ...
        self.assert_to_cnf_transformation("A xnor B", "(B or not A) and (A or not B)")

    def test_negated_xnor(self):
        """Test negated xnor expression."""
        self.assert_to_cnf_transformation("~(A xnor B)", r"(~A \/ ~B) /\ (A \/ B)")

    def test_simple_impl(self):
        """Test simple implies expression."""
        self.assert_to_cnf_transformation("A -> B", r"~A \/ B")
    ...
    def test_simple_and(self):
        ...
        self.assert_to_cnf_transformation("A and B", "A and B")

    def test_negated_and(self):
        """Test negated and expression."""
        self.assert_to_cnf_transformation("not (A and B)", "not A or not B")

    def test_simple_nand(self):
        """Test simple nand expression."""
        self.assert_to_cnf_transformation("A nand B", "not A or not B")

    def test_negated_nand(self):
        """Test negated nand expression."""
        self.assert_to_cnf_transformation("not (A nand B)", "A and B")

    def test_simple_or(self):
        """Test simple or expression."""
        self.assert_to_cnf_transformation("A or B", "A or B")
    ...
    def test_simple_nor(self):
        ...
        self.assert_to_cnf_transformation("A nor B", "not A and not B")

    def test_negated_nor(self):
        """Test negated nor expression."""
        self.assert_to_cnf_transformation("~(A nor B)", r"A \/ B")
    ...
    def test_already_cnf_exprs(self):
        ...
        self.assert_to_cnf_transformation("A and 1 and B", "A and 1 and B")
        self.assert_to_cnf_transformation(
    ...
    def test_mix_of_primitive_operators(self):
        ...
        self.assert_to_cnf_transformation(
            "(A and B and C) or not (A and D) or (A and (B or C) or (D and (E or F)))",
