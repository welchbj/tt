...
class TestApplyIdempotentLaw(unittest.TestCase):
    ...
    def test_expressions_with_constants(self):
        ...
        self.assert_apply_idempotent_law_transformation("0 or 0", "0")
        self.assert_apply_idempotent_law_transformation("0 and 0", "0")
        self.assert_apply_idempotent_law_transformation("1 or 1", "1")
        self.assert_apply_idempotent_law_transformation("1 and 1", "1")
        self.assert_apply_idempotent_law_transformation("1 or ~0", "1")
        self.assert_apply_idempotent_law_transformation("~0 or 1", "1")
        self.assert_apply_idempotent_law_transformation("0  or ~1", "0")
        self.assert_apply_idempotent_law_transformation("~1 or 0", "0")
        self.assert_apply_idempotent_law_transformation("1 and ~0", "1")
        self.assert_apply_idempotent_law_transformation("~0 and 1", "1")
        self.assert_apply_idempotent_law_transformation("0 and ~1", "0")
        self.assert_apply_idempotent_law_transformation("~1 and 0", "0")
        self.assert_apply_idempotent_law_transformation(
            "0 and A and B and C and 0", "0 and A and B and C"
        )
        self.assert_apply_idempotent_law_transformation(
        ...
        self.assert_apply_idempotent_law_transformation(
            "(1 or 1) and (1 or 1)", "1 and 1"
        )
        self.assert_apply_idempotent_law_transformation(
            "A or B or 1 or ~0", "A or B or 1"
        )
    ...
    def test_cnf_clauses(self):
        ...
        self.assert_apply_idempotent_law_transformation(
            "(A or A) and (B or B) and (C or C)", "A and B and C"
        )
        self.assert_apply_idempotent_law_transformation(
