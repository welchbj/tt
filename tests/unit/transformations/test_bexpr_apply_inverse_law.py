...
class TestApplyInverseLaw(unittest.TestCase):
    ...
    def test_from_boolean_expression_object(self):
        ...
        self.assert_apply_inverse_law_transformation(BooleanExpression("A or ~A"), "1")
    ...
    def test_simple_binary_cases(self):
        ...
        self.assert_apply_inverse_law_transformation("A and ~A", "0")

        self.assert_apply_inverse_law_transformation("~A and A", "0")

        self.assert_apply_inverse_law_transformation("B or not B", "1")

        self.assert_apply_inverse_law_transformation("!B or B", "1")
    ...
    def test_complex_expressions(self):
        ...
        self.assert_apply_inverse_law_transformation(
            "A xor B -> (~A and A)", "A xor (B -> 0)"
        )

        self.assert_apply_inverse_law_transformation(
            "(A and B and C and ~C) or (D or ~~~D)", "0 or 1"
        )
